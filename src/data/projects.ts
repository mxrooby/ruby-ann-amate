...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Internal Operations Management Platform',
    role: 'Fullstack Developer',
    year: '2026',
    overview:
      'An internal operations platform designed to streamline business workflows, manage leads and clients, and centralize operational processes in one system.',
    responsibilities: [
      'Built role-based access control (RBAC) for different user roles and permissions.',
      'Implemented Google OAuth and JWT-based authentication.',
      'Developed lead management and lead-to-client conversion workflows.',
      'Implemented AI-assisted background automation for operational workflows.',
    ],
    technologies: [
      'TypeScript',
      'Next.js',
    ...
    github: null,
    githubNote: 'Repository coming soon...',
    takeaway:
      'This project strengthened my full-stack development, authentication, database design, role-based access control, and AI-assisted application development skills.',
    previews: [],
  },
  {
    id: 'accomplishment-reflection',
    title: 'Personal Accomplishment & Reflection Platform',
    role: 'Fullstack Developer',
    year: '2026',
    overview:
      'A full-stack platform for recording personal accomplishments, organizing progress, and generating AI-assisted reflections from users’ activity.',
    responsibilities: [
      'Designed and implemented RESTful APIs using NestJS and PostgreSQL.',
      'Built authentication and authorization using Argon2id and JWT.',
      'Implemented validation, testing, and API documentation workflows.',
      'Integrated Gemini API for AI-assisted reflections and insights.',
    ...
    githubNote: 'Repository coming soon...',
    takeaway:
      'This project strengthened my full-stack development, REST API design, authentication, database management, automated testing, and AI integration skills.',
    previews: [],
  },
];
